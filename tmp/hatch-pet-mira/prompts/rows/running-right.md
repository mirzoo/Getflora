Create one horizontal animation strip for Codex pet `mira`, state `running-right`.
...
Identity: same pet in every frame: compact friendly flower-coder mascot; thoughtful builder energy; small blossom cap, tiny satchel, tidy posture; inspired by Getflora resale marketplace and Russian-language engineering workflow; no logos, no text, no UI. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: polished soft sticker mascot, clean outline, compact readable silhouette, fresh green and coral accents, not monochrome.
